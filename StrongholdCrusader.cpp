...
#include <iostream>
#include "EXE/Rendering/ViewportRenderState.hpp"

using EXE::WindowsHelper::Enums::BOOLEnum;
...
int main(int argc, char** argv)
{
	...
	BOOLEnum result = DAT_ViewportRenderState.xyAreValid(atoi(argv[1]), atoi(argv[2]));
