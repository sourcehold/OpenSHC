...
public:
  ...
  private:
    ...
    // To use SFINEA here, it seems to be needed to template the functions
    #define MACRO_CALL_WRAPPER(N) \
      MACRO_FUNC_TEMPLATE_HEADER(, Ret, N, ) struct Wrapper<MACRO_FUNC_PTR_TYPE_CDECL(Ret, N)> { private: template<typename R> struct CallHelper { static R __cdecl call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) Ret ret = CorePtrResolver::value(MACRO_PARAMETER_LIST(N)); MACRO_WRAPPER_BODY_POSTCALL(N) return ret; } }; template<> struct CallHelper<void> { static void __cdecl call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) CorePtrResolver::value(MACRO_PARAMETER_LIST(N)); MACRO_WRAPPER_BODY_POSTCALL(N) } }; public: typedef CallHelper<Ret> Function; }; \
      MACRO_FUNC_TEMPLATE_HEADER(, Ret, N, ) struct Wrapper<MACRO_FUNC_PTR_TYPE_STDCALL(Ret, N)> { private: template<typename R> struct CallHelper { static R __stdcall call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) Ret ret = CorePtrResolver::value(MACRO_PARAMETER_LIST(N)); MACRO_WRAPPER_BODY_POSTCALL(N) return ret; } }; template<> struct CallHelper<void> { static void __stdcall call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) CorePtrResolver::value(MACRO_PARAMETER_LIST(N)); MACRO_WRAPPER_BODY_POSTCALL(N) } }; public: typedef CallHelper<Ret> Function; }; \
      MACRO_CLASS_FUNC_TEMPLATE_HEADER(, Ret, Class, N, ) struct Wrapper<MACRO_FUNC_PTR_TYPE_MEMBER(Ret, Class, N)> { private: template<typename R> struct CallHelper { R call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) Ret ret = (((Class*)(this))->*CorePtrResolver::value)(MACRO_PARAMETER_LIST(N)); MACRO_WRAPPER_BODY_POSTCALL(N) return ret; } }; template<> struct CallHelper<void> { void call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) (((Class*)(this))->*CorePtrResolver::value)(MACRO_PARAMETER_LIST(N)); MACRO_WRAPPER_BODY_POSTCALL(N) } }; public: typedef CallHelper<Ret> Function; }; \
      MACRO_CLASS_FUNC_TEMPLATE_HEADER(, Ret, Class, N, ) struct Wrapper<MACRO_FUNC_PTR_TYPE_THISCALL(Ret, Class, N)> { private: template<typename R> struct CallHelper { R call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) Ret ret = CorePtrResolver::value(((Class*)(this)) MACRO_PARAMETER_LIST_WITH_COMMA_PREFIX(N)); MACRO_WRAPPER_BODY_POSTCALL(N) return ret; } }; template<> struct CallHelper<void> { void call(MACRO_ARG_PARAMETER_LIST(N)) { MACRO_WRAPPER_BODY_PRECALL(N) CorePtrResolver::value(((Class*)(this)) MACRO_PARAMETER_LIST_WITH_COMMA_PREFIX(N)); MACRO_WRAPPER_BODY_POSTCALL(N) } }; public: typedef CallHelper<Ret> Function; };
