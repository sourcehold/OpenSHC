/**
  ...
  path: 'OpenSHC/Globals/DAT_ModalMenuArrayPointerToStackTop.hpp'
*/
...
// GLOBAL: STRONGHOLDCRUSADER 0x00DF42A4
// StructResolver::Instance<OpenSHC::UI::MenuModal *,14631588>::instance
