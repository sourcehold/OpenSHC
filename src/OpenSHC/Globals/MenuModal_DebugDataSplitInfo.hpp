/**
  ...
  path: 'OpenSHC/Globals/MenuModal_DebugDataSplitInfo.hpp'
*/
...
// GLOBAL: STRONGHOLDCRUSADER 0x00DF4A54
// StructResolver::Instance<OpenSHC::UI::MenuModal,14633556>::instance
