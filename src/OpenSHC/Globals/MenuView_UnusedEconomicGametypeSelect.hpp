/**
  ...
  path: 'OpenSHC/Globals/MenuView_UnusedEconomicGametypeSelect.hpp'
*/
...
// GLOBAL: STRONGHOLDCRUSADER 0x00B979B4
// StructResolver::Instance<OpenSHC::UI::MenuView,12155316>::instance
