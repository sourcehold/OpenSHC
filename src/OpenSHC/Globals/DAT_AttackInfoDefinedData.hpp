/**
  ...
  path: 'OpenSHC/Globals/DAT_AttackInfoDefinedData.hpp'
*/

#pragma once

#include "OpenSHC/AI/AttackInfo/AttackInfoDefinedData.hpp"
...
MACRO_STRUCT_INSTANCE(Address::SHC_3BB0A8C1_0x00B4C704);
