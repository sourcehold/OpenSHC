/**
  ...
  path: 'OpenSHC/WindowsHelper/Enums/GeneralWindowsMessage.hpp'
*/
...
namespace WindowsHelper {
    namespace Enums {
        typedef enum GeneralWindowsMessage {

            WM_NULL = 0, // 0x00000000
            WM_CREATE = 1, // 0x00000001
            WM_DESTROY = 2, // 0x00000002
            WM_MOVE = 3, // 0x00000003
            WM_SIZE = 5, // 0x00000005
            WM_ACTIVATE = 6, // 0x00000006
            WM_SETFOCUS = 7, // 0x00000007
            WM_KILLFOCUS = 8, // 0x00000008
        ...
        } GeneralWindowsMessage;

        static_assert_cpp98_obj(sizeof(GeneralWindowsMessage) == 4, GeneralWindowsMessage);
    } // namespace Enums
} // namespace WindowsHelper
} // namespace OpenSHC
