...
#pragma pack(push, 1)
    ...
    typedef struct ViewportState {
        ...
        undefined4 dwPreviewWorldX; // 0x00000014 length: 4
        undefined4 dwPreviewWorldY; // 0x00000018 length: 4
        ...
        undefined4 dwLastInteractionTime; // 0x00000034 length: 4
        undefined4 field14_0x38; // 0x00000038 length: 4
        undefined4 dwBuildingPlacementValid; // 0x0000003C length: 4
