...
#pragma pack(push, 1)
    ...
    typedef struct BlendingDefinedData {
        ...
        int DefaultPlayerSlotUnitColor[9]; // 0x00002714 length: 36
        int PlayerSlotUnitColor[9]; // 0x00002738 length: 36
        ...
        pointer campaign_map_england[6]; // 0x00002FFC length: 24
