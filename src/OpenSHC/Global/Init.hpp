...
namespace Global {
    namespace Init {
        ...
        void __stdcall Constructor_MenuView_UnusedHelpTextEditor();
        ...
        void __stdcall Constructor_MenuView_UnusedDemoBuyItScreen();

        void __stdcall Constructor_MenuView_IntroVideo();
        ...
        void __stdcall Constructor_Menu_NewMapMaptype();

        void __stdcall Constructor_Menu_NewMapMapsize();

        void __stdcall Constructor_Menu_UnusedChooseAvailableKeeps();
        ...
        void __stdcall CreateInGameWinDefeatWindowDisplayElement();
