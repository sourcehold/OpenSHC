    ...
    namespace SFX {
        ...
        void __stdcall UpdateUnitLossSpeechFeedback()
        {
            ...
            if (DAT_GL_Counter::instance >= 2
                && 50 > DAT_TotalUnitValueLossesEnemyHistory::instance[0] + DAT_CurrentPlayerUnitLosses::instance) {
                int playerUnitLosses1to2
                    = DAT_CurrentPlayerUnitLossesHistory::instance[1] + DAT_CurrentPlayerUnitLossesHistory::instance[2];
                int totalEnemyUnitLosses1to2 = DAT_TotalUnitValueLossesEnemyHistory::instance[1]
                    + DAT_TotalUnitValueLossesEnemyHistory::instance[2];
                if (playerUnitLosses1to2 + totalEnemyUnitLosses1to2 > 150) {
                    _relative1
                        = MACRO_CALL(Game_Func::RelativeValueForGenie)(playerUnitLosses1to2, totalEnemyUnitLosses1to2);
                    int playerUnitLosses1to9 = 0;
                    for (int i = 1; i < 10; ++i) {
                        playerUnitLosses1to9 += DAT_CurrentPlayerUnitLossesHistory::instance[i];
                    }
                    int totalEnemyUnitLosses1to9 = 0;
                    for (int i = 1; i < 10; ++i) {
                        totalEnemyUnitLosses1to9 += DAT_TotalUnitValueLossesEnemyHistory::instance[i];
                    }
                    _relative2
                        = MACRO_CALL(Game_Func::RelativeValueForGenie)(playerUnitLosses1to9, totalEnemyUnitLosses1to9);
                                ...
                                if (DAT_GameCore::instance.genieVoiceActive && iVar3 == -1) {
                                    ...
                                    if (iVar3 <= -3) {
                                        ...
                                        if ((iVar7 != -1)
                                            ...
                                            MACRO_CALL_MEMBER(AI::AICState_Func::playFriendlyVictoryBikFromPlayer,
                                                DAT_AICState::ptr)(iVar7);
                                        }
                                    }
                                }
                            }
            ...
            if (1 < DAT_DestroyedBuildingsCount::instance
                && 5 < DAT_DestroyedBuildingsCountHistory::instance[0] + DAT_DestroyedBuildingsCountHistory::instance[1]
