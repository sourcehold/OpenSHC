    ...
    namespace SFX {
        namespace SFXState_Func {
            ...
            MACRO_FUNCTION_RESOLVER(void (SFXState::*)(SoundEffectIDInt), false, Address::SHC_3BB0A8C1_0x00449C40,
                &SFXState::scheduleSFXWithVariation)
            scheduleSFXWithVariation;
            ...
            MACRO_FUNCTION_RESOLVER(undefined (SFXState::*)(), false, Address::SHC_3BB0A8C1_0x0044A050,
                &SFXState::resetAmbientSoundCounters)
            resetAmbientSoundCounters;
            ...
            MACRO_FUNCTION_RESOLVER(void (SFXState::*)(AmbientSFXTypeInt), false, Address::SHC_3BB0A8C1_0x0044A0F0,
                &SFXState::playAmbientSFXStream)
            playAmbientSFXStream;

            MACRO_FUNCTION_RESOLVER(
                void (SFXState::*)(int), false, Address::SHC_3BB0A8C1_0x0044A1B0, &SFXState::playAmbientSFXStream2)
            playAmbientSFXStream2;
            ...
            MACRO_FUNCTION_RESOLVER(
                void (SFXState::*)(), false, Address::SHC_3BB0A8C1_0x0044C740, &SFXState::updateSFXAndPlayQueuedSounds)
            updateSFXAndPlayQueuedSounds;
