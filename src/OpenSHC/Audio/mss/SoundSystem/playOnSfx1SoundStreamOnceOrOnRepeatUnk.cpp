...
namespace Audio {
    namespace MSS {
        ...
        // FUNCTION: STRONGHOLDCRUSADER 0x0047B590
        void SoundSystem::playOnSfx1SoundStreamOnceOrOnRepeatUnk(char* filename)
        {
            ...
            MACRO_CALL_MEMBER(SoundSystem_Func::playSoundStreamUnk, this)(
                enums::SND_STR_SFX_1Unk, filename, FLAG_SOUND_UNINTERRUPTABLE | 1);
        }
