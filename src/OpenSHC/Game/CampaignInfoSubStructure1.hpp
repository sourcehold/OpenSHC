/**
  ...
  path: 'OpenSHC/Game/CampaignInfoSubStructure1.hpp'
*/
...
#pragma pack(push, 1)
    // SIZE: 0x00000054
    typedef struct CampaignInfoSubStructure1 {
    ...
    } CampaignInfoSubStructure1;
#pragma pack(pop)

    static_assert_cpp98_obj(sizeof(CampaignInfoSubStructure1) == 84, CampaignInfoSubStructure1);
} // namespace Game
} // namespace OpenSHC
