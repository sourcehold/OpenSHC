...
#pragma pack(push, 1)
    ...
    typedef struct MissionDefinedData {
        ...
        CampaignInfoStruct1 campaignUnk_PrepareCfg_0x28; // 0x00000028 length: 88
        int campaignUnk_PrepareCfg_0x80[461]; // 0x00000080 length: 1844
        ...
        int greatestLordScreenCfg_0x7d4[18][2]; // 0x000007D4 length: 144
        char scenarioDescription_DoEverCfg_0x864[20][32]; // 0x00000864 length: 640
        int field25_0xae4[5]; // 0x00000AE4 length: 20
        int crusadeMissionIntro_DoEverCfg_0xaf8[2]; // 0x00000AF8 length: 8
        int field27_0xb00[20]; // 0x00000B00 length: 80
        int sortColumn; // 0x00000B50 length: 4
        int scenarioDescription_DoEverCfg_0xb54[26]; // 0x00000B54 length: 104
        int crusadeMap_DoEveryFrameCfg_0xbbc[50][2]; // 0x00000BBC length: 400
        int crusadeMap_DoEveryFrameCfg_0xd4c[30][2]; // 0x00000D4C length: 240
        int crusadeMap_DoEveryFrameCfg_0xe3c[30][2]; // 0x00000E3C length: 240
        int crusadeMap_DoEveryFrameCfg_0xf2c[50]; // 0x00000F2C length: 200
        int crusadeMap_DoEveryFrameCfg_0xff4[50][4]; // 0x00000FF4 length: 800
        int crusadeMap_DoEveryFrameCfg_0x1314[22]; // 0x00001314 length: 88
        undefined4 descending; // 0x0000136C length: 4
        int tacticalPowerBar_MainCfg_0x1370; // 0x00001370 length: 4
        undefined1 padding_0x1374[8]; // 0x00001374 length: 8
        int historyBookEdgeUnkCfg_0x137c[50]; // 0x0000137C length: 200
        char historicMissionIntro_DoEveCfg_0x1444[20][32]; // 0x00001444 length: 640
