...
namespace IO {
    namespace DecoderBuffer_Func {
        ...
        MACRO_FUNCTION_RESOLVER(unsigned int(__cdecl*)(char* buf, unsigned int* size, void* param), false,
            Address::SHC_3BB0A8C1_0x0046D270, &OpenSHC::IO::DecoderBuffer::ReadBufferAndComputeHash)
        ReadBufferAndComputeHash;

        MACRO_FUNCTION_RESOLVER(void(__cdecl*)(char* buf, unsigned int* size, void* param), false,
