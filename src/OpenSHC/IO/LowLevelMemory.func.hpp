...
namespace IO {
    namespace LowLevelMemory_Func {
        ...
        MACRO_FUNCTION_RESOLVER(undefined (LowLevelMemory::*)(), false, Address::SHC_3BB0A8C1_0x0046A910,
            &LowLevelMemory::setMemoryToValue0x010)
        setMemoryToValue0x010;

        MACRO_FUNCTION_RESOLVER(undefined (LowLevelMemory::*)(), false, Address::SHC_3BB0A8C1_0x0046A970,
            &LowLevelMemory::setMemoryToValue0x100)
        setMemoryToValue0x100;

        MACRO_FUNCTION_RESOLVER(
            undefined (LowLevelMemory::*)(), false, Address::SHC_3BB0A8C1_0x0046AAF0, &LowLevelMemory::copyData0x001)
        copyData0x001;

        MACRO_FUNCTION_RESOLVER(
            undefined (LowLevelMemory::*)(), false, Address::SHC_3BB0A8C1_0x0046AB30, &LowLevelMemory::copyData0x010)
        copyData0x010;

        MACRO_FUNCTION_RESOLVER(
            undefined (LowLevelMemory::*)(), false, Address::SHC_3BB0A8C1_0x0046ABA0, &LowLevelMemory::copyData0x100)
        copyData0x100;
