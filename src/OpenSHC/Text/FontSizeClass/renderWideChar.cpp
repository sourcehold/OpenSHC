...
namespace Text {
...

    {
        ...
        charId = MACRO_CALL_MEMBER(OpenSHC::Util::WideCharMultiByteState_Func::wideCharToByteUnk,
            DAT_WideCharMultiByteState::ptr)((WCHAR)param_1);
        iVar1 = MACRO_CALL_MEMBER(OpenSHC::Text::FontSizeClass_Func::renderCharUnk, this)(
            charId, param_2, param_3, param_4, param_5);
        return iVar1;
    }
