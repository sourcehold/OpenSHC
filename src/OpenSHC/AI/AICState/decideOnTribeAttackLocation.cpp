    ...
    void AICState::decideOnTribeAttackLocation(uint tribeID)
    {
        ...
        if (DAT_TribesState::instance.tribes[tribeID].counter
            ...
            int unitID = MACRO_CALL_MEMBER(
                OpenSHC::Map::Units::TribesState_Func::getUnitIDForIndexInTribe, DAT_TribesState::ptr)(tribeID, 0);
            if (unitID != 0
                && MACRO_CALL_MEMBER(
                ...
                if (moatWasHit != 0) {
                    MACRO_CALL_MEMBER(OpenSHC::Map::Units::UnitsState_Func::relayTribeInstruction, DAT_UnitsState::ptr)(
                        tribeID, (UnitInstructionType)35,
                        DAT_ViewportRenderState::instance.translationMatrix[y].addXgetTile + x, 0, 0);
                    return;
                }
                MACRO_CALL_MEMBER(OpenSHC::Map::Units::UnitsState_Func::relayTribeInstruction, DAT_UnitsState::ptr)(
        ...
        if (DAT_TribesState::instance.tribes[tribeID].tribeSubtype1 != 182
            ...
            if (targetBuildingID != 0
                ...
                && MACRO_CALL_MEMBER(AICState_Func::checkTribeActivityPercentages, this)(tribeID, FALSE, TRUE)
                    != FALSE) {
            ...
            if (buildingID != 0) {
                MACRO_CALL_MEMBER(OpenSHC::Map::Units::UnitsState_Func::relayTribeInstruction, DAT_UnitsState::ptr)(
                    tribeID, OpenSHC::Map::Units::UIT_ATTACK_BUILDING, buildingID,
            ...
            if (MACRO_CALL_MEMBER(OpenSHC::AI::AICState_Func::canNavigateUnitsFromTileToTargetTile, this)(tribeID,
                    DAT_ViewportRenderState::instance.translationMatrix[destinationY].addXgetTile + destinationX)
                == FALSE)
                return;
        ...
        if (buildingID == 0) {
            ...
            MACRO_CALL_MEMBER(OpenSHC::Map::Navigation::PathFindingState_Func::pathfindingForAttacksUnk,
                ...
                (short)DAT_TileMapState::instance.PathConnectionLayer[DAT_UnitsState::instance
        ...
        int destinationX
            = destinationTile - DAT_ViewportRenderState::instance.translationMatrix[destinationY].addXgetTile;
