...
namespace AI {
    ...
    void AICState ::setAICParameters_07(int param_1)

    {
        ...
        this->aics[param_1].criticalPopularity = 5000;

        this->aics[param_1].lowestPopularity = 6000;

        this->aics[param_1].highestPopularity = 9000;

        this->aics[param_1].taxesMin = 1;

        this->aics[param_1].taxesMax = 8;

        this->aics[param_1].farm1 = 0;

        this->aics[param_1].populationPerFarm = 100;

        this->aics[param_1].unknown011 = 0x14;

        this->aics[param_1].maxFood = 500;
        ...
        this->aics[param_1].aiRequestDelay = 0x1e;

        this->aics[param_1].minimumGoodsRequiredAfterTrade = 0;

        this->aics[param_1].doubleRationsFoodThreshold = 0;

        this->aics[param_1].maxWood = 0x1e;

        this->aics[param_1].maxStone = 0x14;
        ...
        this->aics[param_1].populationPerWoodcutter = 2;

        this->aics[param_1].populationPerQuarry = 5;
        ...
        this->aics[param_1].maxWoodcutters = 0xf;

        this->aics[param_1].maxPitchrigs = 1;

        this->aics[param_1].maxFarms = 6;

        this->aics[param_1].buildInterval = 5;

        this->aics[param_1].resourceRebuildDelay = 0x50;
        ...
        this->aics[param_1].defWallPatrolRallyTime = 10;
        ...
        this->aics[param_1].unknown072 = 800;

        this->aics[param_1].unknown073 = 0x50;
        ...
        this->aics[param_1].DefDiggingUnitMax = 2;
        ...
        this->aics[param_1].recruitProbAttackWeak = 0x14;

        this->aics[param_1].recruitProbAttackStrong = 0x28;

        this->aics[param_1].RecruitIntervalWeak = 8;

        this->aics[param_1].RecruitInterval = 8;

        this->aics[param_1].RecruitIntervalStrong = 4;

        this->aics[param_1].SortieUnitRangedMin = 0;

        this->aics[param_1].SortieUnitRanged = 0x48;

        this->aics[param_1].SortieUnitMeleeMin = 3;
        ...
        this->aics[param_1].OuterPatrolGroupsMove = 0;

        this->aics[param_1].DefUnit1 = 0x48;

        this->aics[param_1].DefUnit2 = 0x48;

        this->aics[param_1].DefUnit3 = 0x4b;

        this->aics[param_1].RaidUnitsBase = 0x14;

        this->aics[param_1].RaidUnit1 = 0x48;

        this->aics[param_1].HarassingSiegeEnginesMax = 0;
        ...
        this->aics[param_1].AttForceSupportAllyThreshold = 5;

        this->aics[param_1].AttForceRallyPercentage = 0x1e;

        this->aics[param_1].AttMovingTribesThreshold = 100;

        this->aics[param_1].AttAssaultDelay = 0;

        this->aics[param_1].AttUnitPatrolRecommandDelay = 0x28;

        this->aics[param_1].AttCoordinationPreference = 0x14;
        ...
        this->aics[param_1].AttDiggingUnit = 0;

        this->aics[param_1].AttDiggingUnitMax = 0;
        ...
        this->aics[param_1].AttUnitBackupMax = 0x78;
