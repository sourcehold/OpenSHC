    ...
    void AICState::updateAIStrengthState(int playerID, int aiRecruitUnitChoicePreference)
    {
        ...
        if (_aiRecruitUnitChoice == OpenSHC::AI::AIRUC_RAIDING) {
            if (DAT_GameState::instance.playerDataArray[playerID].totalRaidingTroopsUnk >= MACRO_CALL_MEMBER(
                    OpenSHC::AI::AICState_Func::getCurrentDesiredAttackRaidUnitCount, this)(_aicIndex, playerID))
                _aiRecruitUnitChoice = OpenSHC::AI::AIRUC_ATTACKING;
        ...
        } else if (MACRO_CALL_MEMBER(OpenSHC::AI::AICState_Func::teamIsWeakRelativeToEnemy, this)(playerID, FALSE)) {
