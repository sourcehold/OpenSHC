...
namespace AI {
    ...
    int AICState::addUnitToSmallestBehaviourTypeTribe(undefined4 playerID, undefined4 param_2, undefined4 aiUnitBehaviourType)
    {
        ...
        int _tribeTypeOffset = DAT_SkirmishDefinedData::instance.DAT_AIUnitBehaviourTypeMapping[(int)aiUnitBehaviourType + -10];
...
switchD_004ccd78_caseD_10:
            int _tribeID_groupsCount1 = (int)DAT_GameState::instance.playerDataArray[_playerID].aiTribeIDs[_tribeTypeOffset];
            if ((_tribeID_groupsCount1 != 0) &&
                (DAT_TribesState::instance.tribes[_tribeID_groupsCount1].uid == DAT_GameState::instance.playerDataArray[_playerID].aiTribeUIDs[_tribeTypeOffset])) {
                return _tribeID_groupsCount1;
            }
            _selectedTribe = MACRO_CALL_MEMBER(Map::Units::TribesState_Func::createTribeForPlayer, DAT_TribesState::ptr)(_playerID);
            ...
            if (_tribeTypeOffset < _maxOffset) {
                do {
                    ...
                    if ((_tribeID_2 == 0) ||
                        (DAT_TribesState::instance.tribes[_tribeID_2].uid != DAT_GameState::instance.playerDataArray[_playerID].aiTribeUIDs[_tribeTypeOffset])) {
                        _selectedTribe = MACRO_CALL_MEMBER(Map::Units::TribesState_Func::createTribeForPlayer, DAT_TribesState::ptr)(_playerID);
                        _selectedSlot = _tribeTypeOffset;
                        break;
                    }
        ...
        if (0 < _selectedTribe) {
            ...
            DAT_GameState::instance.playerDataArray[_playerID].aiTribeUIDs[_selectedSlot] = DAT_TribesState::instance.tribes[_selectedTribe].uid;
