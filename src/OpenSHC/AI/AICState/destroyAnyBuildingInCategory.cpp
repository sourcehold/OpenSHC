                ...
                if (((pBVar2->logicalState != 0) && (pBVar2->logicalState != Map::Buildings::BLS_REMOVE)) &&
                    ...
                    if (buildingCategory == AINDBC_FEAR_FACTOR_BUILDINGS) {
                        ...
                        if (((BVar1 != Map::Buildings::BT_CESSPIT) && (BVar1 != Map::Buildings::BT_BURNINGSTAKE)) &&
                            ...
                            (((BVar1 != Map::Buildings::BT_DUNGEON && (BVar1 != Map::Buildings::BT_STRETCHINGRACK)) && (BVar1 != Map::Buildings::BT_RACKFLOGGING)))) &&
                            ...
                            ((((BVar1 != Map::Buildings::BT_POND && (BVar1 != Map::Buildings::BT_GALLOWS)) && (BVar1 != Map::Buildings::BT_STOCKS)) &&
                            ((BVar1 != Map::Buildings::BT_WITCHHOIST && (BVar1 != Map::Buildings::BT_MAYPOLE)))))))))))))))) {
                        ...
                        if (((BVar1 != Map::Buildings::BT_FLETCHER) && (BVar1 != Map::Buildings::BT_BLACKSMITH)) &&
                            ...
                            (((BVar1 != Map::Buildings::BT_ARMOURER && (BVar1 != Map::Buildings::BT_TANNER)) && (BVar1 != Map::Buildings::BT_INN)))) &&
                            (((BVar1 != Map::Buildings::BT_APOTHECARY && (BVar1 != Map::Buildings::BT_CHAPEL)) && (BVar1 != Map::Buildings::BT_CHURCH)))))) {
                        ...
                        BVar1 = pBVar2->buildingType;
                        if (((((BVar1 != Map::Buildings::BT_GATEHOUSELARGE) && (BVar1 != Map::Buildings::BT_GATEHOUSESMALL)) &&
                            ((BVar1 != Map::Buildings::BT_DRAWBRIDGE &&
                            ((((BVar1 != Map::Buildings::BT_TOWER1 && (BVar1 != Map::Buildings::BT_TOWER2)) && (BVar1 != Map::Buildings::BT_TOWER3)) &&
                            ((BVar1 != Map::Buildings::BT_TOWER4 && (BVar1 != Map::Buildings::BT_TOWER5)))))))) && (BVar1 != Map::Buildings::BT_ENGINEERSGUILD)) &&
                        ...
                        if (((BVar1 != Map::Buildings::BT_OXTETHER) && (BVar1 != Map::Buildings::BT_IRONMINE)) &&
                            ...
                            (((BVar1 != Map::Buildings::BT_BAKERY && (BVar1 != Map::Buildings::BT_BREWERY)) && (BVar1 != Map::Buildings::BT_QUARRY)))))) {
                            bVar2 = BVar1 == Map::Buildings::BT_MILL;
LAB_004d04de:
                            if (!bVar2) goto LAB_004d04f9;
                        }
                    }
                    else {
                    ...
                    MACRO_CALL_MEMBER(Map::Buildings::BuildingsState_Func::giveBackResourceForDestroyedBuilding, DAT_BuildingsState::ptr)(_buildingID, playerID, 0x32);
                    MACRO_CALL_MEMBER(Map::Buildings::BuildingsState_Func::destroyBuilding, DAT_BuildingsState::ptr)(_buildingID);
                }
LAB_004d04f9:
