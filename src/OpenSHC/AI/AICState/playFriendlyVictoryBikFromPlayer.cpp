...
namespace AI {
    ...
    void AICState::playFriendlyVictoryBikFromPlayer(int playerID)
    {
        ...
        if (iVar1 != 0) {
            MACRO_CALL_MEMBER(Rendering::Bink::AIMessageQueue_Func::playBikVideoFromPlayer, DAT_VideoBikQueue::ptr)(playerID, (int)DAT_GameState::instance.playerDataArray[playerID].aiType - 1, 10);
        }
    }
}
}
