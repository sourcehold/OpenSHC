...
namespace AI {
    ...
    void AICState::aiCommandTribe11StandGroundToGate(int playerID)
    {
        ...
        if ((((DAT_GameState::instance.playerDataArray[playerID].aiType != AITA_NULL) &&
            ...
            (DAT_TribesState::instance.tribes[iVar2].uid == DAT_GameState::instance.playerDataArray[playerID].aiTribeUIDs[0xb])) &&
            ...
            iVar1 = MACRO_CALL_MEMBER(Map::Units::TroopValueState_Func::moveTribeToNearbyGatehouse, DAT_TroopValueState::ptr)(iVar2);
            if (iVar1 == 0) {
                MACRO_CALL_MEMBER(Map::Units::TroopValueState_Func::moveTowardsParticularUnits, DAT_TroopValueState::ptr)(iVar2);
            }
        }
    }
}
