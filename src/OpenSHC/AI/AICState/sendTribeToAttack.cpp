...
namespace AI {
    ...
    void AICState::sendTribeToAttack(int playerID)
    {
        ...
        if ((DAT_GameState::instance.playerDataArray[playerID].aiType != AITA_NULL) &&
            ...
            if ((DAT_TribesState::instance.tribes[tribeID].uid == DAT_GameState::instance.playerDataArray[playerID].aiTribeUIDs[0xbd]) &&
                ...
                MACRO_CALL_MEMBER(Map::Units::TribesState_Func::assignAttackTargetsForTribe, DAT_TribesState::ptr)(tribeID, Map::Units::STBT_0x3fb);
            }
        }
    }
}
