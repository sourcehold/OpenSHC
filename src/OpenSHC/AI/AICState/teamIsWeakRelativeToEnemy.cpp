...
namespace AI {
    ...
    BOOLEnum AICState::teamIsWeakRelativeToEnemy(int playerID, BOOLEnum param_2)
    {
        ...
        if (_totalEnemyTroopValue == 0) {
            ...
            _relativeStrength = (short)((DAT_GameState::instance.playerDataArray[playerID].totalTeamTroopValue * 100) / _totalEnemyTroopValue);
        }
        ...
        if (param_2 == FALSE) {
            ...
            BOOLEnum BVar2 = MACRO_CALL_MEMBER(Game::GameStateStructures_Func::checkKeepEnclosed, DAT_GameState::ptr)(playerID);
            if (BVar2 != FALSE) {
