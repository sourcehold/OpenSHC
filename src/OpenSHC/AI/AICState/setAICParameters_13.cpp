...
namespace AI {
    ...
    // FUNCTION: STRONGHOLDCRUSADER 0x004C9CF0
    void AICState ::setAICParameters_13(int param_1)

    {
        ...
        this->aics[param_1].populationPerQuarry = 0x14;
        ...
        this->aics[param_1].maxIronmines = 2;

        this->aics[param_1].maxWoodcutters = 0xc;

        this->aics[param_1].maxPitchrigs = 1;

        this->aics[param_1].maxFarms = 0x10;

        this->aics[param_1].buildInterval = 1;
        ...
        this->aics[param_1].SortieUnitMeleeMin = 0xf;

        this->aics[param_1].SortieUnitMelee = 0x46;

        this->aics[param_1].DefDiggingUnitMax = 0x3c;
        ...
        this->aics[param_1].AttForceRandom = 0;

        this->aics[param_1].SortieUnitRangedMin = 5;

        this->aics[param_1].RaidUnitsBase = 5;

        this->aics[param_1].RaidUnitsRandom = 5;

        this->aics[param_1].RaidUnit1 = 0x49;
        ...
        this->aics[param_1].AttMaxAssassins = 0x28;
        ...
        this->aics[param_1].AttUnitMain1 = 0x49;
