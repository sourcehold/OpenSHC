    ...
    void AICState::aiGiveOuterPatrolCommand(int playerID)
    {
        ...
        if (_aiType != 0) {
            ...
            if (((0 < _count) &&
                ...
                *piVar1 = *piVar1 + 1,
                (int)this->aics[_aiType - 1].OuterPatrolRallyDelay <= DAT_GameState::instance.playerDataArray[playerID].outerPatrolRallyDelayTracker)) &&
                ...
                do {
                    ...
                    if (((_tribeID != 0) &&
                        (DAT_TribesState::instance.tribes[_tribeID].uid == DAT_GameState::instance.playerDataArray[playerID].aiTribeUIDs[_index + 0xaa])) &&
                        ...
                        if (((int)this->aics[_aiType - 1].OuterPatrolGroupsMove == 0) ||
                            (_buildingID = MACRO_CALL_MEMBER(AICState_Func::getTargetableBuildingForPlayerID, this)(playerID, _index),
                            _buildingID == 0)) {
                            _buildingID2 = MACRO_CALL_MEMBER(AICState_Func::selectBuildingFromAListOfBuildingTypes, this)(playerID);
                            if (_buildingID2 == 0) goto LAB_004d2a44;
                            _tile = (int)DAT_BuildingsState::instance.buildings[_buildingID2].buildingEntryX +
                                DAT_ViewportRenderState::instance.translationMatrix[DAT_BuildingsState::instance.buildings[_buildingID2].buildingEntryY].addXgetTile;
                        }
                        else {
                            _tile = (int)DAT_BuildingsState::instance.buildings[_buildingID].buildingEntryX +
                                DAT_ViewportRenderState::instance.translationMatrix[DAT_BuildingsState::instance.buildings[_buildingID].buildingEntryY].addXgetTile;
                        }
                        if (_tile != 0) {
                            ...
                            _canNavigate = MACRO_CALL_MEMBER(AICState_Func::canNavigateUnitsFromTileToTargetTile, this)(_tribeID, _tile);
                            if (_canNavigate == FALSE) {
                                MACRO_CALL_MEMBER(AICState_Func::sendUnitsToCampfire, this)(_tribeID, playerID);
                            }
                            else {
                                MACRO_CALL_MEMBER(Map::Units::TribesState_Func::commandUnitsToLocation, DAT_TribesState::ptr)(_tribeID, _tile - iVar3, (int)sVar2, 0);
                            }
                        }
                    }
LAB_004d2a44:
