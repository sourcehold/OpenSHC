        ...
        *piVar1 = *piVar1 + 1;
        ...
        do { \
            if ((_tile) != 0) { \
                ...
                BOOLEnum BVar5_ = MACRO_CALL_MEMBER(OpenSHC::AI::AICState_Func::canNavigateUnitsFromTileToTargetTile, this)((_tribeID3), (_tile)); \
                if (BVar5_ == FALSE) { \
                    MACRO_CALL_MEMBER(OpenSHC::AI::AICState_Func::sendUnitsToCampfire, this)((_tribeID3), playerID); \
                } else { \
                    MACRO_CALL_MEMBER(OpenSHC::Map::Units::TribesState_Func::commandUnitsToLocation, DAT_TribesState::ptr)((_tribeID3), (uint)((int)((_tile) - iVar4_)), (uint)((int)((int)sVar2_)), 0); \
                } \
            } \
        } while(0)
