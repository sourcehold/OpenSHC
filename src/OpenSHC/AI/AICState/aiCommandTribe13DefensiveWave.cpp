...
namespace AI {
    ...
    void AICState::aiCommandTribe13DefensiveWave(int param_1)
    {
        ...
        if ((DAT_GameState::instance.playerDataArray[param_1].aiType != AITA_NULL) &&
            ...
            if ((DAT_TribesState::instance.tribes[tribeID].uid == DAT_GameState::instance.playerDataArray[param_1].aiTribeUIDs[0xd]) &&
                ...
                MACRO_CALL_MEMBER(Map::Units::TribesState_Func::assignAttackTargetsForTribe, DAT_TribesState::ptr)(tribeID, Map::Units::STBT_0x3f4);
            }
        }
    }
}
