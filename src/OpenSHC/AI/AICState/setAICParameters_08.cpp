...
namespace AI {
    ...
    void AICState ::setAICParameters_08(int param_1)
    {
        this->aics[param_1].farm2 = 0x20;
        this->aics[param_1].farm3 = 0x20;
        ...
        this->aics[param_1].SiegeEngine4 = 0x3b;
        this->aics[param_1].SiegeEngine5 = 0x28;
        this->aics[param_1].SiegeEngine6 = 0x28;
        this->aics[param_1].AttMaxEngineers = 0x10;
        this->aics[param_1].AttDiggingUnit = 0x19;
        this->aics[param_1].AttDiggingUnitMax = 6;
        ...
        this->aics[param_1].AttMaxTunnelers = 3;
        ...
        this->aics[param_1].AttUnitSiegeDefMax = 4;
        this->aics[param_1].AttUnitSiegeDefGroupsCount = 2;
