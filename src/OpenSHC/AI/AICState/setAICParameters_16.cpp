...
namespace AI {
    ...
    void AICState ::setAICParameters_16(int param_1)

    {
        ...
        this->aics[param_1].recruitGoldThreshold = 0x32;
        ...
        this->aics[param_1].maxPitchrigs = 0;
        ...
        this->aics[param_1].recruitProbAttackDefault = 0x28;

        this->aics[param_1].recruitProbAttackStrong = 0x32;

        this->aics[param_1].SortieUnitMeleeMin = 0x14;

        this->aics[param_1].SortieUnitMelee = 0x25;

        this->aics[param_1].DefWalls = 0x1e;

        this->aics[param_1].DefTotal = 0x1e;

        this->aics[param_1].RaidUnitsBase = 0x1e;

        this->aics[param_1].RaidUnitsRandom = 10;

        this->aics[param_1].RaidUnit1 = 0x25;
        ...
        this->aics[param_1].AttCoordinationPreference = 0x50;
        ...
        this->aics[param_1].AttMaxEngineers = 8;

        this->aics[param_1].AttDiggingUnit = 0x16;

        this->aics[param_1].AttDiggingUnitMax = 10;
        ...
        this->aics[param_1].AttUnitMain1 = 0x25;
