    ...
    void AICState::playThanksBikFromPlayerToPlayer(int playerID, int targetPlayerID)
    {
        ...
        if (iVar1 != 0) {
            ...
            if (((targetPlayerID == DAT_GameSynchronyState::instance.currentPlayerSlotID) &&
                (DAT_GameState::instance.playerDataArray[DAT_GameSynchronyState::instance.currentPlayerSlotID].lordKilledByPlayerID == 0)) &&
                ((DVar2 = timeGetTime(), DWORD_00eb0b18::instance == 0 || (1199999 < DVar2 - DWORD_00eb0b18::instance)))) {
                DWORD_00eb0b18::instance = DVar2;
                MACRO_CALL_MEMBER(Rendering::Bink::AIMessageQueue_Func::playBikVideoFromPlayer, DAT_VideoBikQueue::ptr)(playerID, iVar1, 0xf);
            }
        }
    }
}
