...
namespace AI {
    ...
    void AICState::playNervous1BikFromPlayer(int playerID)
    {
        ...
        if ((iVar1 != 0) && (DAT_GameState::instance.playerDataArray[playerID].someAiCountdown5 == 0)) {
            ...
            MACRO_CALL_MEMBER(Rendering::Bink::AIMessageQueue_Func::playBikVideoFromPlayer, DAT_VideoBikQueue::ptr)(playerID, (int)DAT_GameState::instance.playerDataArray[playerID].aiType - 1, 8);
        }
    }
}
}
