...
namespace AI {
    ...
    void AICState::sendAITribe_0xf_toAttackPatrol(int playerID)
    {
        ...
        if ((DAT_GameState::instance.playerDataArray[playerID].aiType != AITA_NULL) &&
            ...
            if ((DAT_TribesState::instance.tribes[_tribeID].uid == DAT_GameState::instance.playerDataArray[playerID].aiTribeUIDs[0xf]) &&
                ...
                MACRO_CALL_MEMBER(Map::Units::TroopValueState_Func::sendAttackingPatrolTribeToComputedDestination, DAT_TroopValueState::ptr)(_tribeID);
                return;
            }
        }
    }
