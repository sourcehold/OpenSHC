...
namespace AI {
    ...
    void AICState ::setAICParameters_12(int param_1)

    {
        ...
        this->aics[param_1].maxFood = 0x50;
        ...
        this->aics[param_1].RaidUnit1 = 0x4b;

        this->aics[param_1].HarassingSiegeEnginesMax = 3;

        this->aics[param_1].HarassingSiegeEngine1 = 0xbe;

        this->aics[param_1].HarassingSiegeEngine2 = 0xbe;

        this->aics[param_1].HarassingSiegeEngine3 = 0x166;
        ...
        this->aics[param_1].SiegeEngine3 = 0x3d;
