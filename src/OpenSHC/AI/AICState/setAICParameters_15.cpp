...
namespace AI {
    ...
    // FUNCTION: STRONGHOLDCRUSADER 0x004CA4D0
    void AICState ::setAICParameters_15(int param_1)
    {
        this->aics[param_1].farm1 = 0x21;
        this->aics[param_1].farm3 = 0x21;
        this->aics[param_1].farm4 = 0x21;
        ...
        this->aics[param_1].populationPerQuarry = 7;
        this->aics[param_1].populationPerIronmine = 7;
        this->aics[param_1].aiRequestDelay = 0xc;
        this->aics[param_1].maxResourceOther = 0xc;
        ...
        this->aics[param_1].recruitProbRaidWeak = 0x28;
        ...
        this->aics[param_1].recruitProbDefWeak = 0x32;
        ...
        this->aics[param_1].SortieUnitMelee = 0x1c;
        ...
        this->aics[param_1].RaidUnitsBase = 0x10;
