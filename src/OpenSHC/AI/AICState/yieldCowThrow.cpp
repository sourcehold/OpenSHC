...
namespace AI {
    ...
    BOOLEnum AICState::yieldCowThrow(int playerID)
    {
        ...
        if ((((_ai != AITA_NULL) && (DAT_GameState::instance.mapAndTime.noCowThrowing == 0)) &&
            (this->DAT_AICArray[_ai - 1].CowThrowInterval != 0)) &&
            ...
            *_pCounter = *_pCounter + 1,
            (int)this->DAT_AICArray[_ai - 1].CowThrowInterval < DAT_GameState::instance.playerDataArray[playerID].aiCowThrowCounter)))) {
