...
namespace AI {
...

    {
        ...
        int _totalTroopValueOfEnemy;

        iVar1 = DAT_TroopValueState::instance.attackInfo.playerTotalTroopValueOfTroopsNearKeep[playerID];

        _totalTroopValueOfEnemy = DAT_GameState::instance.playerDataArray[playerID].totalEnemyTroopValue;
        ...
        if (DAT_GameState::instance.playerDataArray[playerID].isNotNervousByEnemyTroopValue == 0) {
            ...
            if (iVar1 < DAT_GameState::instance.playerDataArray[playerID]
