...
namespace AI {
    ...
    void AICState::playVictory2BikFromPlayerToPlayer(int playerID, int targetPlayerID)
    {
        ...
        if ((((DAT_GameState::instance.playerDataArray[targetPlayerID].aiType != AITA_NULL)
            ...
            && (((iVar1 = MACRO_CALL_MEMBER(Map::Units::UnitsState_Func::getAliveLordForPlayer, DAT_UnitsState::ptr)(
                      playerID),
                     iVar1 != 0 && (DAT_GameState::instance.playerDataArray[targetPlayerID].someAiCountdown4 == 0))
            ...
            MACRO_CALL_MEMBER(Rendering::Bink::AIMessageQueue_Func::playBikVideoFromPlayer, DAT_VideoBikQueue::ptr)(
                targetPlayerID, (int)DAT_GameState::instance.playerDataArray[targetPlayerID].aiType - 1, 0xb);
        }
    }
}
}
