...
namespace AI {
    ...
    void AIVState::aiPlacePitchrig(int playerID)
    {
        ...
        MACRO_CALL_MEMBER(AIVState_Func::findAppropriateGridLocationForResourceTypeBuilding, this)(playerID, AIGCRT_OIL);
        ...
        MACRO_CALL_MEMBER(Map::TileMapState_Func::placeBuilding, DAT_TileMapState::ptr)(playerID,
            this->buildingApproriateGridXPosition * 5, this->buildingAppropriateGridYPosition * 5, Commands::M_MAPPER_PITCH_WORKINGS,
