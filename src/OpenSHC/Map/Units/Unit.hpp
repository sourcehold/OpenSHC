...
#pragma pack(push, 1)
        ...
        typedef struct Unit {
            ...
            int woodCutterChopsCount; // 0x0000004C length: 4
            ...
            short field38_0x56; // 0x00000056 length: 2
            short field39_0x58; // 0x00000058 length: 2
            short field40_0x5a; // 0x0000005A length: 2
            int field41_0x5c; // 0x0000005C length: 4
            int field42_0x60; // 0x00000060 length: 4
            int field43_0x64; // 0x00000064 length: 4
            int vanish; // 0x00000068 length: 4
            short field45_0x6c; // 0x0000006C length: 2
            short field46_0x6e; // 0x0000006E length: 2
            ...
            short field64_0x90; // 0x00000090 length: 2
            ...
            int woodcutterTreeUID; // 0x000000A8 length: 4
            ...
            short field97_0xd0; // 0x000000D0 length: 2
            short field98_0xd2; // 0x000000D2 length: 2
            ...
            int field105_0xe8; // 0x000000E8 length: 4
            ...
            short field129_0x2a8; // 0x000002A8 length: 2
            short targetShootRelated; // 0x000002AA length: 2
            short field131_0x2ac; // 0x000002AC length: 2
            ...
            short orientation; // 0x000002B6 length: 2
            undefined1 padding_0x2b8[2]; // 0x000002B8 length: 2
            ...
            short field143_0x2c4; // 0x000002C4 length: 2
            ...
            short field171_0x308; // 0x00000308 length: 2
            ...
            int field191_0x340; // 0x00000340 length: 4
            ...
            int field199_0x350; // 0x00000350 length: 4
            int field200_0x354; // 0x00000354 length: 4
            short unknownTestAgainst0_2; // 0x00000358 length: 2
            short distanceToEnemyUnitLadders; // 0x0000035A length: 2
            short field203_0x35c; // 0x0000035C length: 2
            ...
            short field215_0x378; // 0x00000378 length: 2
            short field216_0x37a; // 0x0000037A length: 2
            short field217_0x37c; // 0x0000037C length: 2
            short field218_0x37e; // 0x0000037E length: 2
            ...
            short peasantAlwaysZero; // 0x0000038E length: 2
            undefined1 padding_0x390[2]; // 0x00000390 length: 2
            ...
            short field233_0x39a; // 0x0000039A length: 2
            ...
            short field243_0x3b0; // 0x000003B0 length: 2
            ...
            int field248_0x3bc; // 0x000003BC length: 4
            short field249_0x3c0; // 0x000003C0 length: 2
            char field250_0x3c2; // 0x000003C2 length: 1
            char rabbitMovementSlowdown; // 0x000003C3 length: 1
            byte field252_0x3c4; // 0x000003C4 length: 1
            byte field253_0x3c5; // 0x000003C5 length: 1
            short field254_0x3c6; // 0x000003C6 length: 2
            int health; // 0x000003C8 length: 4
            int maxHealth; // 0x000003CC length: 4
            byte occupancyOrFlag; // 0x000003D0 length: 1
            byte field258_0x3d1; // 0x000003D1 length: 1
            short field259_0x3d2; // 0x000003D2 length: 2
            ...
            short field279_0x3f2; // 0x000003F2 length: 2
            short field280_0x3f4; // 0x000003F4 length: 2
            undefined1 padding_0x3f6[2]; // 0x000003F6 length: 2
            byte field283_0x3f8; // 0x000003F8 length: 1
            undefined1 laddermanIsInPosition; // 0x000003F9 length: 1
            ...
            byte field289_0x3ff; // 0x000003FF length: 1
            ...
            short field295_0x40a; // 0x0000040A length: 2
            bool isMatchingSpeed; // 0x0000040C length: 1
            bool field297_0x40d; // 0x0000040D length: 1
            bool field298_0x40e; // 0x0000040E length: 1
            char attackFacingDirection; // 0x0000040F length: 1
            byte field300_0x410; // 0x00000410 length: 1
            byte lordDeathProcessedStatus; // 0x00000411 length: 1
            byte ownerOfAssassinScaledObject; // 0x00000412 length: 1
            byte field303_0x413; // 0x00000413 length: 1
            ...
            short field306_0x418; // 0x00000418 length: 2
            undefined2 field307_0x41a; // 0x0000041A length: 2
            int field308_0x41c; // 0x0000041C length: 4
            int field309_0x420; // 0x00000420 length: 4
            short horseArcherShootingVariation; // 0x00000424 length: 2
            short horseArcherShootCheckInterval; // 0x00000426 length: 2
            short field312_0x428; // 0x00000428 length: 2
            ...
            short field316_0x430; // 0x00000430 length: 2
            ...
            ushort field322_0x440; // 0x00000440 length: 2
            short field323_0x442; // 0x00000442 length: 2
            ...
            short cagedogReleaseCheckMoment; // 0x0000044C length: 2
