...
#pragma pack(push, 1)
        ...
        typedef struct Unit {
            ...
            short field100_0xd0; // 0x000000D0 length: 2
            short field101_0xd2; // 0x000000D2 length: 2
            ...
            int field108_0xe8; // 0x000000E8 length: 4
            ...
            short field132_0x2a8; // 0x000002A8 length: 2
            short targetShootRelated; // 0x000002AA length: 2
            short field134_0x2ac; // 0x000002AC length: 2
            ...
            short field147_0x2c4; // 0x000002C4 length: 2
            ...
            short field170_0x2fe; // 0x000002FE length: 2
            short field171_0x300; // 0x00000300 length: 2
            ...
            short field175_0x308; // 0x00000308 length: 2
            ...
            char field196_0x32d; // 0x0000032D length: 1
            ...
            int field207_0x340; // 0x00000340 length: 4
            ...
            int field215_0x350; // 0x00000350 length: 4
            int field216_0x354; // 0x00000354 length: 4
            short unknownTestAgainst0_2; // 0x00000358 length: 2
            short distanceToEnemyUnitLadders; // 0x0000035A length: 2
            short field219_0x35c; // 0x0000035C length: 2
            ...
            short field231_0x378; // 0x00000378 length: 2
            short field232_0x37a; // 0x0000037A length: 2
            short field233_0x37c; // 0x0000037C length: 2
            short field234_0x37e; // 0x0000037E length: 2
            ...
            short field250_0x39a; // 0x0000039A length: 2
            ...
            short field260_0x3b0; // 0x000003B0 length: 2
            ...
            int field265_0x3bc; // 0x000003BC length: 4
            short field266_0x3c0; // 0x000003C0 length: 2
            char field267_0x3c2; // 0x000003C2 length: 1
            undefined1 padding_0x3c3[1]; // 0x000003C3 length: 1
            byte field269_0x3c4; // 0x000003C4 length: 1
            byte field270_0x3c5; // 0x000003C5 length: 1
            short field271_0x3c6; // 0x000003C6 length: 2
            int health; // 0x000003C8 length: 4
            int maxHealth; // 0x000003CC length: 4
            byte occupancyOrFlag; // 0x000003D0 length: 1
            byte field275_0x3d1; // 0x000003D1 length: 1
            short field276_0x3d2; // 0x000003D2 length: 2
            ...
            short field282_0x3dc; // 0x000003DC length: 2
            short field283_0x3de; // 0x000003DE length: 2
            ...
            short field296_0x3f2; // 0x000003F2 length: 2
            short field297_0x3f4; // 0x000003F4 length: 2
            undefined1 padding_0x3f6[2]; // 0x000003F6 length: 2
            byte field300_0x3f8; // 0x000003F8 length: 1
            ...
            byte field306_0x3ff; // 0x000003FF length: 1
            ...
            short field323_0x418; // 0x00000418 length: 2
            undefined2 field324_0x41a; // 0x0000041A length: 2
            int field325_0x41c; // 0x0000041C length: 4
            int field326_0x420; // 0x00000420 length: 4
            short horseArcherShootingVariation; // 0x00000424 length: 2
            short horseArcherShootCheckInterval; // 0x00000426 length: 2
            short field329_0x428; // 0x00000428 length: 2
            ...
            short field333_0x430; // 0x00000430 length: 2
            ...
            ushort field339_0x440; // 0x00000440 length: 2
            short field340_0x442; // 0x00000442 length: 2
