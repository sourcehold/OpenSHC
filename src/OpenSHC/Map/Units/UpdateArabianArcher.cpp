...
namespace Map {
    ...
    using OpenSHC::Map::Units::Behavior::TargetingType;
    using OpenSHC::Map::Units::Behavior::UnitStanceEnum;
    using OpenSHC::Map::Units::States::UnitState;
    using OpenSHC::WindowsHelper::Enums::BOOLEnum;

    // FUNCTION: STRONGHOLDCRUSADER 0x00570400
    void Units::UpdateArabianArcher()
    {
        ...
        DAT_GameState::instance.playerDataArray[owner].countArabianArcher += 1;
        ...
        case OpenSHC::Map::Units::States::US_DETERMINE_NEXT_STATEUnk:
            ...
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].goToRallyPoint != 0) {
                ...
                if (MACRO_CALL_MEMBER(OpenSHC::Map::Buildings::BuildingsState_Func::getKeepLocationForAIUnit,
                        DAT_BuildingsState::ptr)(owner, 10, DAT_CurrentUnitSlotID::instance)
                    != 0) {
                ...
                DAT_GameState::instance.playerDataArray[owner].countArabianArchersRelated += 1;
                return;
            }
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].targetingType
        ...
        case OpenSHC::Map::Units::States::US_MELEE_ATTACK_WALL: {
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp.ANIM_ArabianArcher_Melee
        ...
        case OpenSHC::Map::Units::States::US_RELOAD_WEAPONUnk:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                      .fixme_integerArrayArabianArcher1[DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
            ...
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].jugglerCount != 0) {
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].jugglerCount == 1) {
                    DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                        = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
                              .facingDirectionMapOrientationCorrected
                        + 0x299 + DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame * 8;
                    return;
                }
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].jugglerCount != -1) {
                    return;
        ...
        case OpenSHC::Map::Units::States::US_AIM_WEAPONUnk: {
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                      .fixme_integerArrayArabianArcher2[DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
                              .animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame > 0) {
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].jugglerCount == 0) {
                    DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
        ...
        case OpenSHC::Map::Units::States::US_FIRE_WEAPONUnk:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                      .fixme_integerArrayArabianArcher3[DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
                              .animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame > 0) {
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].jugglerCount == 0) {
                    DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                    ...
                    DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                        = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
                              .facingDirectionMapOrientationCorrected
                        + 0x119 + DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame * 8;
                }
            }
            if ((DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame == 22
                    && DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
                ...
                if (target < 0) {
                    ...
                    if (MACRO_CALL_MEMBER(OpenSHC::Map::Entities::EntityState_Func::isBrazierNearby,
                        ...
                        MACRO_CALL_MEMBER(OpenSHC::Map::Units::TroopValueState_Func::lightPitchIfNecessary,
                            DAT_TroopValueState::ptr)(DAT_CurrentUnitSlotID::instance, target);
                        if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].targetingType
                            == OpenSHC::Map::Units::UIT_LIGHT_PITCH) {
                            projectile = (OpenSHC::Map::Entities::EntityType)0x5d;
                        }
        ...
        case OpenSHC::Map::Units::States::US_LOOK_AROUNDUnk:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                      .fixme_integerArrayArabianArcher5[DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance]
                              .animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber = 0x379;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                    = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 0x36c;
            }
            if (DAT_UnitHasBecomeIdle::instance == 0) {
                return;
            }
            ...
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].field283_0x3f8 == 0
                && (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].targetingType
                    ...
                    || DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].targetingType
                        == OpenSHC::Map::Units::UIT_ATTACK_LAND)) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].field283_0x3f8 = 1;
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationCycleNumber = 200;
            }
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                = (~DAT_CurrentUnitSlotID::instance & 1) | 0x362;
        ...
        case OpenSHC::Map::Units::States::US_SIT_DOWNUnk: {
            ...
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].substate == 0x65
                ...
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].substate == 0x65) {
                    ...
                    DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                        = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                              .ANIM_ArabianArcher_Idle_SitDown[DAT_UnitsState::instance
                    ...
                    if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                        ...
                        DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                            = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 864;
                    }
                } else {
                    // sitting
                    ...
                    if (variant == 0) {
                        DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                            = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                                  .ANIM_ArabianArcher_Idle1[DAT_UnitsState::instance
                                          .units[DAT_CurrentUnitSlotID::instance]
                                          .animationCycleNumber];
                    } else if (variant == 1) {
                        DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                            = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                                  .ANIM_ArabianArcher_Idle2[DAT_UnitsState::instance
                                          .units[DAT_CurrentUnitSlotID::instance]
                                          .animationCycleNumber];
                    } else if (variant == 2) {
                        DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                            = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                                  .ANIM_ArabianArcher_Idle3[DAT_UnitsState::instance
                                          .units[DAT_CurrentUnitSlotID::instance]
                                          .animationCycleNumber];
                    } else if (variant == 3) {
                        DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                            = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                                  .ANIM_ArabianArcher_Idle4[DAT_UnitsState::instance
                                          .units[DAT_CurrentUnitSlotID::instance]
                                          .animationCycleNumber];
                    }
                    if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame > 0) {
                ...
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                    ...
                    DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                        = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 0x360;
                    if (DAT_UnitHasBecomeIdle::instance == 0) {
                        return;
                    }
                }
                ...
                if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationCycleNumber
                    > (int)((DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].fixedRng & 15) + 2)) {
                    DAT_UnitHasBecomeIdle::instance = 1;
                } else if (DAT_UnitHasBecomeIdle::instance == 0) {
                    return;
                }
        ...
        case OpenSHC::Map::Units::States::US_DEATH_01:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp.ANIM_Frames_UnitDeath
                      [DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber = 0x390;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                    = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 0x378;
            }
            if (DAT_UnitHasBecomeIdle::instance != 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].state.generic
                    = OpenSHC::Map::Units::States::US_DISAPPEAR;
        ...
        case OpenSHC::Map::Units::States::US_DEATH_03:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp.ANIM_Frames_UnitDeath
                      [DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber = 0x3c0;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                    = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 0x3a8;
            }
            if (DAT_UnitHasBecomeIdle::instance != 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].state.generic
                    = OpenSHC::Map::Units::States::US_DISAPPEAR;
        ...
        case OpenSHC::Map::Units::States::US_STONE_DEATH_03:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp.ANIM_Frames_UnitDeath
                      [DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber = 0x3a8;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                    = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 0x390;
            }
            if (DAT_UnitHasBecomeIdle::instance != 0) {
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].state.generic
                    = OpenSHC::Map::Units::States::US_DISAPPEAR;
