...
namespace Map {
    ...
    // FUNCTION: STRONGHOLDCRUSADER 0x00575C40
    void Units::UpdateArabianSwordsman()
    {
        ...
        DAT_GameState::instance.playerDataArray[owner].countArabSwordsman += 1;
        ...
        case OpenSHC::Map::Units::States::US_DETERMINE_NEXT_STATEUnk:
            ...
            if (DAT_UnitsState::instance.units[unitID].goToRallyPoint != 0) {
                ...
                if (MACRO_CALL_MEMBER(OpenSHC::Map::Buildings::BuildingsState_Func::getKeepLocationForAIUnit,
                        DAT_BuildingsState::ptr)(owner, 16, unitID)
                    != 0) {
                ...
                DAT_GameState::instance.playerDataArray[owner].someCount23 += 1;
        ...
        case OpenSHC::Map::Units::States::US_MELEE_ATTACK_WALL: {
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp.ANIM_ArabianSwordsman_Melee
        ...
        case OpenSHC::Map::Units::States::US_MELEE_ATTACK:
            ...
            DAT_UnitsState::instance.units[unitID].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                      .ANIM_ArabianSwordsman_Melee[DAT_UnitsState::instance.units[unitID].animationCycleNumber];
        ...
        case (UnitState)3:
            ...
            DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp.DAT_ANI_ASWORD_UNKNOWN_1
                      [DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationCycleNumber];
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
        ...
        case OpenSHC::Map::Units::States::US_IDLEUnk: {
            ...
            if (variant == 0) {
                DAT_UnitsState::instance.units[unitID].animationFrame
                    = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                          .ANIM_ArabianSwordsman_Idle1[DAT_UnitsState::instance.units[unitID].animationCycleNumber];
            } else if (variant == 1) {
                DAT_UnitsState::instance.units[unitID].animationFrame
                    = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                          .ANIM_ArabianSwordsman_Idle2[DAT_UnitsState::instance.units[unitID].animationCycleNumber];
            } else if (variant == 2) {
                DAT_UnitsState::instance.units[unitID].animationFrame
                    = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                          .ANIM_ArabianSwordsman_Idle3[DAT_UnitsState::instance.units[unitID].animationCycleNumber];
            } else {
                DAT_UnitsState::instance.units[unitID].animationFrame
                    = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                          .ANIM_ArabianSwordsman_Idle4[DAT_UnitsState::instance.units[unitID].animationCycleNumber];
            }
            ...
            if (DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame <= 0) {
                ...
                DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].gfxNumber
                    = DAT_UnitsState::instance.units[DAT_CurrentUnitSlotID::instance].animationFrame + 0x170;
            }
            if (DAT_GameState::instance.playerDataArray[owner].aiControlStatusRelated > 0) {
                DAT_UnitHasBecomeIdle::instance = 1;
        ...
        case OpenSHC::Map::Units::States::US_DEATH_01:
            ...
            if (DAT_UnitsState::instance.units[unitID].animationFrame <= 0) {
                DAT_UnitsState::instance.units[unitID].gfxNumber = 0x195;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[unitID].gfxNumber
                    = DAT_UnitsState::instance.units[unitID].animationFrame + 0x17d;
            }
            if (DAT_UnitHasBecomeIdle::instance != 0) {
                DAT_UnitsState::instance.units[unitID].state.generic = OpenSHC::Map::Units::States::US_DISAPPEAR;
            }
        ...
        case OpenSHC::Map::Units::States::US_DEATH_03:
            ...
            DAT_UnitsState::instance.units[unitID].animationFrame
                = (char)DAT_UnitPropertiesDefinedData::instance.Frames_Shared_UnitClimbingUp
                      .field14_0x9fc[DAT_UnitsState::instance.units[unitID].animationCycleNumber];
            if (DAT_UnitsState::instance.units[unitID].animationFrame <= 0) {
                DAT_UnitsState::instance.units[unitID].gfxNumber = 0x1af;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[unitID].gfxNumber
                    = DAT_UnitsState::instance.units[unitID].animationFrame + 0x195;
            }
            if (DAT_UnitHasBecomeIdle::instance != 0) {
                DAT_UnitsState::instance.units[unitID].state.generic = OpenSHC::Map::Units::States::US_DISAPPEAR;
            }
        ...
        case OpenSHC::Map::Units::States::US_STONE_DEATH_03:
            ...
            if (DAT_UnitsState::instance.units[unitID].animationFrame <= 0) {
                DAT_UnitsState::instance.units[unitID].gfxNumber = 0x1c8;
                DAT_UnitHasBecomeIdle::instance = 1;
            } else {
                DAT_UnitsState::instance.units[unitID].gfxNumber
                    = DAT_UnitsState::instance.units[unitID].animationFrame + 0x1af;
            }
            if (DAT_UnitHasBecomeIdle::instance != 0) {
                DAT_UnitsState::instance.units[unitID].state.generic = OpenSHC::Map::Units::States::US_DISAPPEAR;
            }
