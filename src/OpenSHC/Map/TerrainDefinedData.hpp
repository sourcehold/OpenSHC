...
#pragma pack(push, 1)
    ...
    typedef struct TerrainDefinedData {
        ...
        int brushTileTable[37]; // 0x0000000C length: 148
        ...
        XYPair aivBuildingOffsetsX[4][3]; // 0x0000013C length: 96
        XYPair aivBuildingOffsetsY[4]; // 0x0000019C length: 32
        ...
        XYPair keepPlacementOffsets[24]; // 0x00000444 length: 192
        ...
        XYPair constructionGfxOffsets; // 0x0000068C length: 8
        undefined1 padding_0x694[440]; // 0x00000694 length: 440
        int buildingGfxLayerTable[25]; // 0x0000084C length: 100
        undefined1 padding_0x8b0[4]; // 0x000008B0 length: 4
        int buildingGfxLayerTable2[25]; // 0x000008B4 length: 100
        undefined1 padding_0x918[4]; // 0x00000918 length: 4
        XYPair wheatFarmTileOffsets[4][36]; // 0x0000091C length: 1152
        XYPair hopFarmTileOffsets[2][24]; // 0x00000D9C length: 384
        XYPair appleFarmTileOffsets[8]; // 0x00000F1C length: 64
        WheatFarmFieldSpec dairyFarmTileOffsets[4][27]; // 0x00000F5C length: 1296
        undefined1 padding_0x146c[1280]; // 0x0000146C length: 1280
        XYPair macroLayerOffsets1[4]; // 0x0000196C length: 32
        XYPair macroLayerOffsets2[9]; // 0x0000198C length: 72
        XYPair macroLayerOffsets3[16]; // 0x000019D4 length: 128
        ...
        byte gfxLayerTable[4][2]; // 0x00001D54 length: 8
        byte field2297_0x1d5c[4][2]; // 0x00001D5C length: 8
        UnkBytePair textureTilemapData[8]; // 0x00001D64 length: 16
        ...
        int placementRotationTable[32]; // 0x00001E4C length: 128
        XYPair drawbridgePlacementOffsets[4][9]; // 0x00001ECC length: 288
        int buildingGfxLayerTable3[4][25]; // 0x00001FEC length: 400
        int towerPlacementTable[7][4]; // 0x0000217C length: 112
        int buildingFootprintTable[4][25]; // 0x000021EC length: 400
        int keepMoatTileTable[4][25]; // 0x0000237C length: 400
        int drawbridgeTileTable[26]; // 0x0000250C length: 104
        ...
        XYPair placementMarkerOffsets[501]; // 0x00002764 length: 4008
        int textureTilemapIndices[8]; // 0x0000370C length: 32
        XYPair tileSlopeOffsets[8]; // 0x0000372C length: 64
        XYPair pitchDitchData[4]; // 0x0000376C length: 32
