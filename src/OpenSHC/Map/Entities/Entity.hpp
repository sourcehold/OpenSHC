...
#pragma pack(push, 1)
        ...
        typedef struct Entity {
            ...
            short entityMotionAccumulator_0x1c; // 0x0000001C length: 2
            ...
            int spawnTimeTicks_0x34; // 0x00000034 length: 4
            ...
            short nMoveTargetX; // 0x0000005C length: 2
            short nDeltaXAbs; // 0x0000005E length: 2
            short someMicroX; // 0x00000060 length: 2
            short nMoveTargetY; // 0x00000062 length: 2
            short nDeltaYAbs; // 0x00000064 length: 2
            short someMicroY; // 0x00000066 length: 2
            short projectileVelX_0x68; // 0x00000068 length: 2
            short nProjectilePitchFrame; // 0x0000006A length: 2
            short someCounter_OR_hitGround; // 0x0000006C length: 2
            short nBresenhamStepMinor; // 0x0000006E length: 2
            short nBresenhamStepMajor; // 0x00000070 length: 2
            short nBresenhamError; // 0x00000072 length: 2
            short nMovementOctantMode; // 0x00000074 length: 2
            byte unused_0x76[2]; // 0x00000076 length: 2
            int nLaunchSpeed; // 0x00000078 length: 4
            ...
            short nProjectileActiveFlag; // 0x000000A8 length: 2
            ...
            short nFireEntityTimer; // 0x000000B8 length: 2
            short nProjectileLineOfSightResult; // 0x000000BA length: 2
            short rng_2; // 0x000000BC length: 2
            short gmPictureIndex_0xbe; // 0x000000BE length: 2
            short nPopupYPosition; // 0x000000C0 length: 2
            byte unused_0xc2[2]; // 0x000000C2 length: 2
            int displayValue; // 0x000000C4 length: 4
            short popupAnimParam_0xc8; // 0x000000C8 length: 2
            short popupRenderOffsetX_0xca; // 0x000000CA length: 2
            short field88_0xcc; // 0x000000CC length: 2
            short popupRenderOffsetY_0xce; // 0x000000CE length: 2
            short nProjectileSpawnFlag; // 0x000000D0 length: 2
