    ...
    namespace Buildings {
        ...
        undefined4 BuildingsState::getKeepLocationForAIUnit(int playerID, int param_2, int unitID)
        {
            ...
            if (DAT_GameState::instance.playerDataArray[playerID].mercenaryAssemblyPoints[param_2 - 10][0] == 0) {
                ...
                short pointX = DAT_GameState::instance.playerDataArray[playerID].mercenaryAssemblyPoints[group - 10][0];
                short pointY = DAT_GameState::instance.playerDataArray[playerID].mercenaryAssemblyPoints[group - 10][1];
