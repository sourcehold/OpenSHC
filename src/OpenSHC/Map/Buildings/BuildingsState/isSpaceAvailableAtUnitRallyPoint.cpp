...
namespace Map {
    namespace Buildings {
        ...
        undefined4 BuildingsState::isSpaceAvailableAtUnitRallyPoint(int playerID, int value0to6, int unitID)
        {
            ...
            // constant propagate group = 6 in the rally branch.
            int group = value0to6;
            ...
            if (DAT_GameState::instance.playerDataArray[playerID].barracksAssemblyPoints[value0to6].x != 0) {
                ...
                int pointX = (short)DAT_GameState::instance.playerDataArray[playerID].barracksAssemblyPoints[group].x;
                int pointY = (short)DAT_GameState::instance.playerDataArray[playerID].barracksAssemblyPoints[group].y;
