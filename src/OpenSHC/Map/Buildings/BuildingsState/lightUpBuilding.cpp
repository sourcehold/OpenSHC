        ...
        undefined4 BuildingsState::lightUpBuilding(int buildingID, int burnerPlayerID, int spareGrounds)
        {
            ...
            default:
                ...
                if (this->buildings[buildingID].fireDuration == 0) {
                    if (MACRO_CALL_MEMBER(OpenSHC::Map::Buildings::BuildingsState_Func::getBuildingFlammabilityFactor,
                            this)(buildingID)
                        == 0) {
                        return 0;
                    }
                    ...
                    if (owner == burnerPlayerID
                        && MACRO_CALL_MEMBER(
                               OpenSHC::Map::Buildings::BuildingsState_Func::getBuildingFlammabilityFactor, this)(
                               buildingID)
                            != 4) {
                        return 0;
                    }
                    if (spareGrounds != 0
                        && (this->buildings[buildingID].buildingType == BT_CAMPFIRE
                            || this->buildings[buildingID].buildingType == BT_PARADEGROUND
                            || this->buildings[buildingID].buildingType == BT_CAMPGROUND
                            || this->buildings[buildingID].buildingType == BT_PARADEGROUND2
                            || this->buildings[buildingID].buildingType == BT_PARADEGROUND3
                            || this->buildings[buildingID].buildingType == BT_PARADEGROUND4
                            || this->buildings[buildingID].buildingType == BT_PARADEGROUND5)) {
                        return 1;
                    }
                    ...
                    do {
                        ...
                        int tile = DAT_ViewportRenderState::instance
                                       .translationMatrix[DAT_TileMapState::instance.buildingY + y]
                                       .addXgetTile
                            + DAT_TileMapState::instance.buildingX + x;
                        if (MACRO_CALL_MEMBER(OpenSHC::Map::Entities::EntityState_Func::getFireEntityIDAtTile,
