...
namespace Map {
    namespace Buildings {
        ...
        {
            // Matching note: The remaining differences are register and stack slot allocation.
            ...
            if (pointX != 0) {
                ...
                short pointY
                    = DAT_GameState::instance.playerDataArray[playerIndex].engineersAssemblyPoints[isLadderman].y;
                for (; i < 49; ++i) {
            ...
            for (;; ++i) {
                ...
                if (isLadderman != 0) {
                    x = DAT_GameState::instance.playerDataArray[playerIndex].engineersParadegroundLocations[24 - i].x;
                    y = DAT_GameState::instance.playerDataArray[playerIndex].engineersParadegroundLocations[24 - i].y;
                } else {
